		...
		<>
			...
			<div className="relative overflow-hidden py-20 lg:py-20">
				<div className="relative z-10">
					<div className="container flex max-w-6xl items-center justify-between py-10 lg:py-16">
						<Image src="/garden.png" alt="Garden" width={400} height={400} />
						<div className="mx-auto max-w-xl">
							...
							<div className="mt-2 w-full">
								<h1 className="scroll-m-20 text-balance font-extrabold text-4xl text-lime-600 lg:text-6xl">
